    ...
    return (
        <div className='sm:relative z-2 absolute top-[93%] sm:bottom-0  sm:top-0 justify-center gap-9 sm:gap-1 flex flex-col '>
            <div>
               ...
               <h1 className='font-[Supreme] font-bold  2xl:text-[96px] xl:text-[86px] md:text-[78px]  sm:text-[60px] text-[50px]  text-white leading-[100%] tracking-[-2px] align-middle uppercase'><span className='text-black select-none sm:inline-block hidden invisible'>ai.ii</span>BRANDS.</h1>
            </div>
            <div className='flex-row sm:flex items-center sm:gap-8 lg:w-4/5 md:w-full 2xl:gap-2 xl:gap-2 lg:gap-7 md:gap-8 2xl:ml-42 xl:ml-34 md:ml-31 sm:ml-23 ml-[2px]'>
