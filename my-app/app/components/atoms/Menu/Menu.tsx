      ...
      <div className="sm:flex-row flex-col flex gap-24 sm:gap-12 h-[100%] pt-24 pb-8 sm:pt-0 sm:pb-0  w-full items-center">
        ...
        <div className="xl:w-[275px] lg:w-[240px]  sm:h-100 sm:gap-0 gap-12 w-full sm:w-[174px] md:w-[220px] flex flex-row sm:flex-col justify-around">
          <div className="flex flex-col gap-8">
            <h3 className="text-white font-[Supreme] font-bold sm:text-[14px] text-[12px] leading-[120%] tracking-[2px]">SOC</h3>
            <ul className="sm:gap-0 gap-1 flex flex-col">
              <motion.li whileHover={{color: "#E5E548", transition: { duration: 0.4, ease: "easeInOut" },}} className="text-white font-[Supreme] font-normal sm:text-[12px] text-[10px] leading-[240%] tracking-[1px] cursor-pointer">Instagram</motion.li>
              <motion.li whileHover={{color: "#E5E548", transition: { duration: 0.4, ease: "easeInOut" },}} className="text-white font-[Supreme] font-normal sm:text-[12px] text-[10px] leading-[240%] tracking-[1px] cursor-pointer">Twitter</motion.li>
              <motion.li whileHover={{color: "#E5E548", transition: { duration: 0.4, ease: "easeInOut" },}} className="text-white font-[Supreme] font-normal sm:text-[12px] text-[10px] leading-[240%] tracking-[1px] cursor-pointer">LinkedIn</motion.li>
              <motion.li whileHover={{color: "#E5E548", transition: { duration: 0.4, ease: "easeInOut" },}} className="text-white font-[Supreme] font-normal sm:text-[12px] text-[10px] leading-[240%] tracking-[1px] cursor-pointer">Facebook</motion.li>
            </ul>
          </div>
          <div className="flex flex-col gap-8">
            <h3 className="text-white font-[Supreme] font-bold sm:text-[14px] text-[14px] leading-[120%] tracking-[2px]">NEURO IDEAS HQ</h3>
            <p className="text-white font-[Supreme] font-normal text-[12px] leading-[140%] tracking-[1px]">Nirmana Rd. 32 Building 123 <br /> Kampoeng Ideas <br /> Canggu, Bali</p>
          </div>
        </div>
      </div>
