    ...
    const [play, setPlay] = useState<boolean>(false);
     ...
     return(
       <div className='w-full'>
           ...
           <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8, ease: "easeOut" }}  className='flex-col sm:w-[45%] lg:w-[50%] items-center relative w-full sm:bottom-22 sm:left-55 lg:left-50 justify-center sm:absolute z-12'>
