...
const Land =({scrollTo}:any) => {
    ...
    return (
        <div className='w-full relative z-16'>
           <div className='w-full relative z-16 h-[310px]  sm:h-screen pl-[9%] pr-[9%] sm:pl-28 sm:pr-20 xl:pl-32 xl:pr-21 flex-shrink-0 items-center flex sm:relative bg-[#C4C4C4]'>
