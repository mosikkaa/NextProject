...
const LatestProjects = () => {
    ...
    return (
        <div className='select-none bg-black flex flex-col items-center justify-center gap-20'>
            <div className='h-153.25 lg:h-192 w-91.5 lg:w-285 flex flex-col justify-center gap-12'>
                <Solutions />
                <Button buttonText="READ MORE" />
            </div>

            <div className='w-full pl-6 lg:pl-0 lg:w-285'>
                <p className='mb-30.25 tracking-wider [text-shadow:-1px_-1px_0_#666666,1px_-1px_0_#666666,-1px_1px_0_#666666,1px_1px_0_#666666,0_-1px_0_#666666,0_1px_0_#666666,-1px_0_0_#666666,1px_0_0_#666666] leading-[100%] w-97.5 lg:w-130 font-bold text-[56px] lg:text-[64px]'>LATEST <span className='text-shadow-none line-through decoration-[##E5E548] decoration-3 text-[#E5E548] [-webkit-text-stroke:0px]'><span className='text-black'>sss</span>PROJECTS</span></p>
