...
const LatestProjects = () => {
    ...
    const allProjects = [
        { img: architecture, num: "01", title: 'MAQUILADORA ARCHITECT', description: 'When art meet technology and nature.', type: 'WEB DESIGN / WEB DEVELOPMENT', section: 'ARCHITECTURE' },
        { img: businessConsulting, num: "02", title: 'CODEX CONSULTING', description: 'Codex brings new perspective in business.', type: 'BRAND IDENTITY', section: 'BUSINESS CONSULTING' },
        { img: hikingGears, num: "03", title: 'RAUNG PACK', description: 'Our collaborations with latest outdoors gear.', type: 'WEB DESIGN / WEB DEVELOPMENT', section: 'HIKING GEARS' },
        { img: outdoor, num: "04", title: 'OMBAX SURFBOARDS', description: 'Ombax new logo redefined.', type: 'BRAND IDENTITY', section: 'OUTDOOR' },
        { img: architecture2, num: "05", title: 'MAQUILADORA ARCHITECT', description: 'When art meet technology and nature.', type: 'WEB DESIGN', section: 'ARCHITECTURE' },
        { img: businessConsulting2, num: "06", title: 'CODEX CONSULTING', description: 'Codex brings new perspective.', type: 'BRAND IDENTITY', section: 'BUSINESS' },
        { img: hikingGears2, num: "07", title: 'RAUNG PACK', description: 'Latest outdoors gear for their website.', type: 'WEB DESIGN / WEB DEVELOPMENT', section: 'HIKING GEARS' },
    ...
    return (
        <div className='select-none bg-black flex flex-col items-start lg:items-center pl-6 lg:pl-0 justify-center gap-20 w-full'>
            ...
            <div className='w-full lg:pl-0 lg:w-285'>
                ...
                <div className='mb-6 lg:hidden flex gap-6 overflow-x-auto [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-track]:bg-zinc-900 [&::-webkit-scrollbar-thumb]:bg-white'>
                    {allProjects.map((p, i) => (
                        <ProjectCard key={i} {...p} />
                    ))}
                </div>
                ...
                <div className='hidden lg:block w-full'>
                    <div className="overflow-hidden">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                {(showMore ? allProjects.slice(0, 4) : paginatedProjects).map((p, i) => (
                                    <ProjectCard key={i} {...p} />
                                ))}
                            </motion.div>
                        </AnimatePresence>
                    ...
                    <div className='flex mb-29 w-full items-center justify-between'>
                        ...
                        {!showMore && (
                            <div className="flex items-center gap-2">
                                {[0, 1].map((p) => (
                                    <button key={p} onClick={() => setPage(p)} className={`cursor-pointer w-3 h-3 rounded-full border transition-all duration-300 ${page === p
