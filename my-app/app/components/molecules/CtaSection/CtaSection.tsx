...
import {CtaSectionProps} from "@/app/types/types";


const CtaSection = ({sectionRef,scrollToSection,refs}:CtaSectionProps) => {
  return (
    <section ref={sectionRef} className="bg-[#E5E548] px-[9%] sm:pl-28 sm:pr-20 lg:pr-20 xl:pl-32 xl:pr-21  py-16 font-[Supreme] w-full">
      ...
      <CtaFooter scrollToSection={scrollToSection} refs={refs}/>
    </section>
  )
}
